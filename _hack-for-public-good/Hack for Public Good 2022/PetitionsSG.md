...
4. Members of public feel unheard. Members of the public don’t feel like the government cares about their sentiment or thoughts
...
We need a mechanism to know if a user has already signed a petition, so that there are no duplicate signatures. We want to reduce traceability between the user and their signed petitions. 
...
We generate a unique salt for each petition and hash it together with the user’s sgid (i.e. unique identifying ID generated by sgID).
